...
const CATEGORIES = ['vegetable', 'fruit', 'herb', 'protein', 'flower']
...
export default function AddToInventoryModal({ onSave, onSaveAndPlant, onClose, prefill }) {
  ...
  return (
    <div className="modal-backdrop" onClick={e => e.target === e.currentTarget && onClose()}>
      ...
      >
        <div className="modal-heading">Add to Inventory</div>

        <div className="modal-fields">
          <div className="modal-field">
            <label className="modal-label">Plant name *</label>
            <input value={form.name} onChange={e => set('name', e.target.value)} placeholder="e.g. Roma Tomatoes" />
          </div>
